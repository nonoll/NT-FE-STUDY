import { Expression, Sum, Bank, Money, Franc } from './16';
...
describe('# 드디어, 추상화', () => {
  ...
  //   console.log('sum instanceof Money', sum instanceof Money);
  //   console.log('sum instanceof Sum', sum instanceof Sum);
  //   expect(sum instanceof Money).toEqual(true);
  // });
});
